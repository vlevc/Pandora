	...
	: Super(ObjectInitializer)
{
	...
	ApiGatewayEndpoint = FString::Printf(TEXT("https://mydomen.us-west-2.amazonaws.com/test"));
	LogingURI = FString::Printf(TEXT("/login"));
...
void UOfflineMainMenuWidget::LoginRequest(FString usr, FString pwd) 
{
	...
	LoginHttpRequest->SetURL(ApiGatewayEndpoint + LogingURI);
